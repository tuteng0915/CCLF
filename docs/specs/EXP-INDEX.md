...
**更新时间**: 2026-08-06（EXP-60/61 DONE/NEGATIVE；EXP-62 Stage A positive generation gate，Stage B RUNNING/P0；85 个实验）
...
| **EXP-62** | **RUNNING / P0** | ELF baseline fine-tuning panel | matched continued-training control + full-KD establish the controlled recipe effect, then early/transition/late KD windows test temporal causality | Stage A 2k-step native gate: full-KD PPL 220.0 vs control 261.8，且 D1/D2 同时改善；三个 temporal windows 已启动；见 EXP-62-spec.md |
...
- **RUNNING**: EXP-62 Stage B（matched 2k-step early / transition / late KD windows）
